...
def schema_upgrades() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk__fot_task")),
    )
    op.create_index(
        op.f("ix__fot_task__created_at"), "fot_task", ["created_at"], unique=False
    )
...
def schema_downgrades() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix__fot_task__created_at"), table_name="fot_task")
